...
public class calculator {
   public static void main(String args[])    {
       ...
       // Boolean statements to check the cases
       ...
       // going through the array from the input string, if the element from the array is a space then continue or use the element from
       // the array as a value to switch case
       for(int i = 0; i < infixString.length(); i++){
           ...
           case 'x':try{
                       ...
                       int xx = sc.nextInt();
                       String xVar = Integer.toString(xx);
